      ...
      <v-container fluid fill-height>
        ...
        <v-row v-if="city === 'oakland'">
          ...
          <v-row class="content-row body-row white">
            ...
            <v-col cols=4>
              <Plotly :data="oak_police_budget" :layout="police_budget_layout"
              :display-mode-bar="false"/>
              <p class="graph-title">Oakland Police All Sworn Staff (20XX-20XX)</p>
              <Plotly :data="oak_police_ftes" :layout="police_budget_detail_layout"
              :display-mode-bar="false"/>
            </v-col>
            <v-spacer />
          </v-row>
  ...
  data() {
    return {
      ...
      police_budget_detail_layout: {
        title: {
          text: this.$store.state.city === 'oakland' ? 'Oakland Police Sworn Staff 2010-2019' : 'SF City Police Sub-Departments (1999-2017)',
          font: {
            size: 18,
            family: 'Nunito',
          },
      ...
      police_budget_layout: {
        title: {
          text: this.$store.state.city === 'oakland' ? 'Oakland Police Department Budget 2013-2016' : 'SF City Police Department Budget (1999-2017)',
          font: {
            size: 18,
            family: 'Nunito',
          },
